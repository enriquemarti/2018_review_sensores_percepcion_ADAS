...
This survey is focused in the perception of external elements, that corresponds to the
...
\begin{itemize}
    ...
    stereo vision, either in the automotive field\cite{ambarella2018} or as generic
    ...
    ambient light. Reflections can affect its performance. Devices are 
    ...
    related to LiDAR. 
    A set of infrared LEDs emmit light modulated according to a known scheme.
