...
Section is concluded with two tables summarizing the adequacy of sensor 
...
Direct speed measurement is a really nice feature for any sensor. Up to date,
...
Table \ref{fig:sensors-environ} summarizes the effect of common external
